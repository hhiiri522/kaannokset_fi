...
- Variety-versio: 0.8.12
- Käännös tehty: kesäkuu 2026
- Ota yhteyttä: hhiiri522@gmail.com

<b>Suomenkieliset lainaukset</b>

- Jos haluat ottaa suomenkieliset Soturikissat-lainaukset käyttöön, kopioi tässä kansiossa olevan tekstitiedoston sisältö sellaisenaan.
- Avaa Linuxissa tiedostonhallinta ja näytä piilotiedostot. Mene kotikansioosi. Sieltä pitäisi löytyä piilotiedostona .config-kansio, jonka alta löytyy variety-kansio. Variety-kansiossa on puolestaan kansio nimeltä pluginconfig, jonka sisältä löytyy quotes.txt-tiedosto. Avaa kyseinen tiedosto (se on oletuksena tyhjä) ja liitä sinne kopioimasi.
